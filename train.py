...
def train():
    ...
    images, labels = read_and_decode('/home/chengrui/PycharmProjects/deeplearning/greenhouse/train.tfrecords')
...
#            pdb.set_trace()
            ...
            if (i + 1) == max_steps:
                ...
                saver.save(sess, '/home/chengrui/PycharmProjects/deeplearning/greenhouse/model/model.ckpt', global_step=i)
        coord.request_stop()
        coord.join(threads)
