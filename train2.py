...
batch_size = 64  # 一次性喂入的数据量
lr = 0.0001  # 学习率
n_cls = 4  # 输出层的个数
max_steps = 10000  # 迭代次数

TFRECOREDPATH='/home/chengrui/PycharmProjects/deeplearning/greenhouse/records'
SAVEMODELPATH='/home/chengrui/PycharmProjects/deeplearning/greenhouse/model'
...
def train():
    ...
    images, labels = read_and_decode('/home/chengrui/PycharmProjects/deeplearning/greenhouse/records/train.tfrecords')
    ...
    with tf.Session() as sess:
        ...
        for i in range(max_steps):
            ...
            if i % 10 == 0:
                ...
                saver.save(sess, '/home/chengrui/PycharmProjects/deeplearning/greenhouse/model/model.ckpt',
                           global_step=i)
            if (i + 1) == max_steps:
